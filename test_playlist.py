...
def test_playlist(appid, clientver, is_lite, dfid, mid):
    userid = "1977926089"
    ...
    print(f"Test appid={appid} dfid={dfid} -> {res.status_code}")
    print(res.text)

print("--- Test 3116 with concept dfid ---")
test_playlist("3116", "11440", True, "2ULHpc3qaLZa43In8x0fLJQp", "d9b28f5ddaf921578f6f6f11d074ca23")

print("--- Test 1005 with concept dfid ---")
test_playlist("1005", "12143", False, "2ULHpc3qaLZa43In8x0fLJQp", "d9b28f5ddaf921578f6f6f11d074ca23")

print("--- Test 1005 with empty dfid ---")
test_playlist("1005", "12143", False, "-", "0")
