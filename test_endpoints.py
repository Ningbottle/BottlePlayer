...
def test_endpoint(url_path):
    ...
    params["signature"] = sign_params(params, data_str, True)

    url = f"https://gateway.kugou.com/{url_path}"
    ...
    print(f"{url_path} -> {res.status_code}")
    print(res.text[:200])

test_endpoint("v2/get_all_list")
test_endpoint("v3/get_all_list")
test_endpoint("v5/get_all_list")
test_endpoint("youth/v1/playlist/get_all_list")
test_endpoint("youth/v2/playlist/get_all_list")
